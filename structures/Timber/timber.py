...
class TimberBeam:
    ...
    def shear(self, loads=[],seasoned=None, moisture_content=None, latitude=None, verbose=None):
        """
...
class TimberColumn(TimberBeam):
    ...
    def _compression(self,seasoned=None, moisture_content=None, latitude=None, fc=None, slenderness:function|None = None, g13=None, pc=None, La=None, out_of_plane = None, verbose=None):
        """ 
        ...
        k4 = self._calc_k4(seasoned=seasoned,moisture_content=moisture_content,verbose=verbose)
        k6 = self._calc_k6(latitude=latitude,verbose=verbose)
        k12 = self._calc_k12_compression(pc=pc,g13=g13,La=La,slenderness=slenderness, out_of_plane=out_of_plane, verbose=verbose) 
    ...
    def _calc_k12_compression(self, pc:float|None = None, g13:float|None = None, La:float|None = None, slenderness:function|None = None, out_of_plane:bool|None = None, verbose:bool = True):
        ...
        if g13 is None:
            raise ValueError("g13 not set. This should be selected from table 3.2. and relates to the end restraint of the column."\
                             "Flat ends 0.7\n" \
    ...
    def _calc_S3(self,g13:float|None = None, Lax:float|None = None, verbose:bool = True):
        if Lax is None:
    ...
    def _calc_S4(self,g13:float|None = None, Lay:float|None = None, verbose:bool = True):
